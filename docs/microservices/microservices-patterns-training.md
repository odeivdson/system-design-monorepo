...
* **Onde treinar no Monorepo**: [10-service-mesh-sidecar-proxy](../microservices/10-service-mesh-sidecar-proxy/README.md) e [7-consistent-hashing-ring](../microservices/07-consistent-hashing-ring/README.md).
...
* **Onde treinar no Monorepo**: [2-rate-limiter-distributed](../microservices/02-rate-limiter-distributed/README.md), [3-idempotent-billing](../microservices/03-idempotent-billing/README.md) e [8-bff-mobile-web-aggregator](../microservices/08-bff-mobile-web-aggregator/README.md).
...
* **Onde treinar no Monorepo**: [6-webhook-dispatcher](../microservices/06-webhook-dispatcher/README.md) e [1-threadsafe-lru-cache](../algorithms/01-threadsafe-lru-cache/README.md).
...
* **Onde treinar no Monorepo**: [9-event-sourced-wallet](../microservices/09-event-sourced-wallet/README.md) e [5-inventory-reservation-engine](../microservices/05-inventory-reservation-engine/README.md).
...
* **Onde treinar no Monorepo**: [7-consistent-hashing-ring](../microservices/07-consistent-hashing-ring/README.md).
...
* **Onde treinar no Monorepo**: [9-event-sourced-wallet](../microservices/09-event-sourced-wallet/README.md) e [3-idempotent-billing](../microservices/03-idempotent-billing/README.md).
...
* **Onde treinar no Monorepo**: [10-service-mesh-sidecar-proxy](../microservices/10-service-mesh-sidecar-proxy/README.md).
...
* **Onde treinar no Monorepo**: [8-bff-mobile-web-aggregator](../microservices/08-bff-mobile-web-aggregator/README.md).
...
* **Onde treinar no Monorepo**: [6-webhook-dispatcher](../microservices/06-webhook-dispatcher/README.md) e [2-log-batching-buffer](../algorithms/02-log-batching-buffer/README.md).
...
* **Onde treinar no Monorepo**: [2-rate-limiter-distributed](../microservices/02-rate-limiter-distributed/README.md) e [8-bff-mobile-web-aggregator](../microservices/08-bff-mobile-web-aggregator/README.md).
...
* **Onde treinar no Monorepo**: [11-transactional-outbox-cdc](../microservices/11-transactional-outbox-cdc/README.md).
...
* **Onde treinar no Monorepo**: [13-singleflight-collapsing](../algorithms/13-singleflight-collapsing/README.md).
...
* **Onde treinar no Monorepo**: [12-read-after-write-routing](../microservices/12-read-after-write-routing/README.md).
...
* **Onde treinar no Monorepo**: [14-fencing-token-locks](../algorithms/14-fencing-token-locks/README.md).
...
* **Onde treinar no Monorepo**: [15-stream-backpressure-buffer](../algorithms/15-stream-backpressure-buffer/README.md).
